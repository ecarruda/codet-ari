 ...
 * this rep is not supported, the only difference from the original repo is that i uses python 3 

About
-----

This package contains the Python client library for the Asterisk REST
Interface. It builds upon the [Swagger.py](https://github.com/Thulebona/codet-swaggerpy.git) library, providing an
